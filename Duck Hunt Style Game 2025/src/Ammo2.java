...
public class Ammo2 {
    ...
    public Ammo2() {
        img = getImage("/imgs/ammoBar2.png"); // Load the image file
    ...
    public Ammo2(int x, int y, int scaleX, int scaleY) {
    	this();
    	this.x 		= x;
    	this.y 		= y;
    	this.scaleX = scaleX;
    ...
    //2nd constructor to initialize location and scale!
    public Ammo2(int x, int y, int scaleX, int scaleY, int vx, int vy) {
    	this();
    	this.x 		= x;
    	this.y 		= y;
    	this.scaleX = scaleX;
    ...
    private Image getImage(String path) {
        ...
        try {
            URL imageURL = Ammo2.class.getResource(path);
