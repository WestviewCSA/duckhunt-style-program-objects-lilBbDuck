...
public class BackgroundLayer {
    ...
    public BackgroundLayer() {
        img = getImage("/imgs/foreground.gif"); // Load the image file
    ...
    public BackgroundLayer(int x, int y, int scaleX, int scaleY) {
    	this();
    	this.x 		= x;
    	this.y 		= y;
    	this.scaleX = scaleX;
    ...
    //2nd constructor to initialize location and scale!
    public BackgroundLayer(int x, int y, int scaleX, int scaleY, int vx, int vy) {
    	this();
    	this.x 		= x;
    	this.y 		= y;
    	this.scaleX = scaleX;
    ...
    private Image getImage(String path) {
        ...
        try {
            URL imageURL = BackgroundLayer.class.getResource(path);
